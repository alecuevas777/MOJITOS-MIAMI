      ...
      >
        ...
        <div className={styles.body}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionHint}>
              El pago se realiza por transferencia. Usa estos datos y envía el comprobante por
              WhatsApp.
            </p>
            ...
            {bankFields.length > 0 ? (
              <div className={styles.bankBox}>
                ...
                {copyFeedback && (
                  <p className={cn(styles.feedback, styles.feedbackSuccess)}>{copyFeedback}</p>
                )}
              </div>
            ) : (
              <p className={styles.sectionHint}>
                Los datos bancarios aún no están configurados. Te los enviaremos por WhatsApp al
                confirmar tu pedido.
              </p>
            )}
          </section>
