...
export default function AdminHeader({ onOpenMenu, onCloseMenu, isMenuOpen }) {
  ...
  return (
    <>
      ...
      <header
        className="grid grid-cols-[1fr_auto] items-center gap-2 border-b px-3 py-2 sm:grid-cols-[1fr_auto_1fr] sm:gap-3 sm:px-4"
      ...
      >
        <div className="flex min-w-0 items-center gap-2 justify-self-start sm:gap-3">
          ...
          <img
            src={siteConfig.logo}
            alt={siteConfig.name}
            className="block max-h-8 w-[96px] object-contain object-left sm:max-h-10 sm:w-[120px]"
          />
        </div>
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-1.5 p-1 text-red-400 transition-colors hover:text-red-300"
          >
            <FiLogOut size={14} />
